...
def train(dataset="shakespeare_char", out_dir="run_0", seed_offset=0):
    ...
    final_info = {
        "final_train_loss": lossf,  # 训练结束时的损失
        "best_val_loss": best_val_loss.item(),  # 最佳验证损失
        "total_train_time": time.time() - og_t0,  # 训练总时间
    }
    ...
    final_info["avg_inference_tokens_per_second"] = avg_tokens_per_second  # 平均推理速度
